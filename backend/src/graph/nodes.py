...
def audit_content_node(state: VideoAuditState) -> Dict[str, Any]:
    ...
    # --- Initialize Clients (fixed indentation) ---
    llm = AzureChatOpenAI(
        azure_deployment=os.getenv("AZURE_OPENAI_CHAT_DEPLOYMENT"),
        azure_endpoint=os.getenv("AZURE_OPENAI_ENDPOINT"),          # muhee-mnyj7bo9 resource
    ...
    embeddings = AzureOpenAIEmbeddings(
        ...
        azure_endpoint=os.getenv("AZURE_OPENAI_EMBEDDING_ENDPOINT"), # brandguardainfoundary101 resource
